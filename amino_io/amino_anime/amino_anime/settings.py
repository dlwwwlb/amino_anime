"""
Django settings for amino_anime project.
...
SECRET_KEY = 'django-insecure-d!w9#o==q$i^cxg84kg#7(5!6+4(wd29+0sgz1=#m+38rlt$_x'
...
INSTALLED_APPS = [
    ...
    # 'allauth.socialaccount.providers.google', # если нужна соцсеть
...
WSGI_APPLICATION = 'amino_anime.wsgi.application'
